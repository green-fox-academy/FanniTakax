...
int main(void) {
	...
	__HAL_RCC_GPIOB_CLK_ENABLE(); //yellow with PWM
	    led.Pin = GPIO_PIN_4;
	...
	__HAL_RCC_GPIOF_CLK_ENABLE(); //red
	    led2.Pin = GPIO_PIN_7;
	...
	__HAL_RCC_GPIOF_CLK_ENABLE(); //green
	    led3.Pin = GPIO_PIN_8;
	...
	while (1) {
		...
		if(cnt < 20000){
			__HAL_TIM_SET_COMPARE(&tim_handle2, TIM_CHANNEL_1, valtozo);
		}else{
			__HAL_TIM_SET_COMPARE(&tim_handle2, TIM_CHANNEL_1, 200 - valtozo);
		}
		...
		/*if(cnt >= 0 && cnt < 10000){
		        ...
		        __HAL_TIM_SET_COMPARE(&tim_handle2, TIM_CHANNEL_1, 5);
		    }else if (cnt >= 20000 && cnt < 30000){
		    	__HAL_TIM_SET_COMPARE(&tim_handle2, TIM_CHANNEL_1, 0);
		    	HAL_GPIO_WritePin(GPIOF, GPIO_PIN_7, GPIO_PIN_SET);
		    }else if (cnt >= 30000 && cnt < 40000){
		    	__HAL_TIM_SET_COMPARE(&tim_handle2, TIM_CHANNEL_1, 5);
		    }*/
